...
Status: ✅ Verified
Evidence: TASK-REGISTRY.md（legacy；现对应 `.workspace/tasks/INDEX.md`） now contains "Reference Conventions" section with table defining discuss→discuss-log, plan→discuss, execute→plan source conventions.
...
Status: ✅ Verified
Evidence: TASK-REGISTRY.md（legacy；现对应 `.workspace/tasks/INDEX.md`） lists all 6 task phase directories. AGENTS.md Document Index covers all entry points, phase dirs, skills, and templates. Navigation chain complete: TASK-REGISTRY → phase dirs → phase docs → logs.
