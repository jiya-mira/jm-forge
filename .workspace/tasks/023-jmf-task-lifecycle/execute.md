...
Status: ✅ Verified
Evidence: SKILL.md updated with "About Abandoned State" section explaining Abandoned tasks remain in TASK-REGISTRY.md（legacy；现对应 `.workspace/tasks/INDEX.md`） for historical reference
