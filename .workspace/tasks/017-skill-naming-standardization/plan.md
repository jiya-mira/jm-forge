...
### Step 4: Update TASK-REGISTRY.md（legacy；现对应 `.workspace/tasks/INDEX.md`） Task 3

**Action:**
- Update Task 3 description from `jm-forge-task-* skills` to `jm-forge:<action>` format

**Checkpoint:** `registry-updated`
- TASK-REGISTRY.md（legacy；现对应 `.workspace/tasks/INDEX.md`） Task 3 notes contain `jm-forge:` instead of `jm-forge-task-`
