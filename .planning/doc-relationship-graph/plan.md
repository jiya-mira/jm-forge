...
### Step 3: Update TASK-REGISTRY.md with document relationship note

**Action:** Add reference conventions to TASK-REGISTRY.md header or a dedicated section

**Approach:**
- Append a "Reference Conventions" section explaining the flow: discuss→discuss-log, plan→discuss, execute→plan
- List the entry points (TASK-REGISTRY.md itself, AGENTS.md)

**Checkpoint:** `registry-ref-conventions-added`
- TASK-REGISTRY.md contains a "Reference Conventions" section
...
**Approach:**
- From TASK-REGISTRY.md: should link to all task phase dirs
...
| AGENTS.md and TASK-REGISTRY.md are stable entry points | Low — already established as entry points |
